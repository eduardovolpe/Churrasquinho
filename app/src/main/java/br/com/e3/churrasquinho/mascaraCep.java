...
public class mascaraCep extends EditText {
    ...
    public mascaraCep(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        initialize();

    }

    public mascaraCep(Context context, AttributeSet attrs) {
        super(context, attrs);
        initialize();

    }

    public mascaraCep(Context context) {
        super(context);
        initialize();
    ...
    public String getCleanText() {
        String text = mascaraCep.this.getText().toString();
    ...
    private void initialize() {
        ...
        this.addTextChangedListener(new TextWatcher() {
            public void afterTextChanged(Editable s) {
				 ...
				 */
                isUpdating = true;
                mascaraCep.this.setText(cep);

                mascaraCep.this.setSelection(positioning[length]);
